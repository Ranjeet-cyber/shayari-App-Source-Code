...
protected void onCreate(Bundle savedInstanceState) {
   ...
   // CardView card = (CardView)findViewById(R.id.card12);
    ...
    String[] quote=getResources().getStringArray(R.array.all_quotes);
...
public class SwipeStackAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        btnNxt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MainActivity.this, "btn pre", Toast.LENGTH_SHORT).show();
                mSwipeStack.swipeTopViewToLeft();
            }
        });
        ...
        btnpre.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(MainActivity.this, "btn next", Toast.LENGTH_SHORT).show();
                mSwipeStack.swipeTopViewToRight();
            }
        });
